      ...
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl z-10 px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 z-10 items-center justify-between">
              <div className="absolute inset-y-0 z-10 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center z-10 justify-center rounded-md p-2 absolute text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <Disclosure.Button
                  ...
                  className={classNames(
                    navActive === item.name
                      ...
                      : "text-gray-300 hover:bg-gray-700 hover:text-white",
                    "block rounded-md px-3 py-2 z-100 text-base font-medium"
                  )}
                  aria-current={item.current ? "page" : undefined}
                >
                  {item.name}
